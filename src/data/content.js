...
export const industries = {
  ...
  items: [
    ...
    },
    {
      id: 'consumo',
      name: 'Consumo masivo',
      desc: 'Strategic Workforce Planning regional, compensaciones y planificación estratégica LATAM.',
  ...
  items: [
    {
      ...
      serviceId: 2,
      context: 'Alta rotación en supervisores de operaciones afectaba la continuidad operacional y los costos de reemplazo.',
    ...
    },
    {
      ...
      industryLabel: 'Multinacional',
      service: 'Planificación Estratégica',
      serviceId: 1,
      context: 'Necesidad de anticipar dotación y competencias en 6 países de la región con horizontes de 3 años.',
      solution: 'Strategic Workforce Planning con proyecciones y escenarios por país, implementado para el equipo local.',
      metrics: [
        { id: 'm2-paises', value: '6', label: 'Países cubiertos' },
        { id: 'm2-proyeccion', value: '3', label: 'Años de proyección' },
      ],
    },
    {
      id: 4,
    ...
    },
    {
      ...
      title: 'Plan estratégico 2026 definido con equipo ejecutivo completo',
      metrics: [
        { id: 'm6-actividades', value: '37', label: 'actividades claves definidas' },
        { id: 'm6-objetivos', value: '12', label: 'objetivos estratégicos' },
      ],
      industryLabel: 'Empresa de servicios con presencia nacional · Chile',
      service: 'People Analytics',
      serviceId: 6,
      ...
      detail: {
        ...
        results: [
          ...
          '12 objetivos estratégicos con metas claras y medibles para el período.',
          '37 actividades claves distribuidas en 3 niveles: 15 estratégicas (equipo de conducción), 18 tácticas (unidades de negocio) y 4 proyectos transversales multidisciplinarios.',
        ...
        impact: 'El equipo ejecutivo cerró el taller con un plan completamente operacionalizado — no un documento de intenciones, sino una hoja de ruta con responsables, métricas y fechas. La metodología permitió que las 37 actividades emergieran del propio equipo, lo que aumentó el nivel de compromiso y apropiación del plan. El RoadMap resultante cubre el período 2026-2028 y tiene trazabilidad directa desde cada KPI operacional hasta los pilares estratégicos de la compañía.',
      },
    },
    {
      id: 7,
      ...
      metrics: [
        { id: 'm7-lideres', value: '12', label: 'líderes participantes' },
        { id: 'm7-horas', value: '20h', label: 'horas de levantamiento' },
        { id: 'm7-perfiles', value: '24', label: 'perfiles analizados' },
        { id: 'm7-coincidencia', value: '75%', label: 'coincidencia en brechas clave' },
      ],
...
export const about = {
  ...
  profileRole: 'Fundador y consultor · HR Analytics',
  profileLocation: 'Chile · 18+ años en RR.HH.',
  aboutTitle: 'Sobre la firma',
  aboutText: 'Somos una consultora boutique especializada en People Analytics, con más de 3 años en el mercado y 18 años de experiencia acumulada en gestión de personas.',
  ...
  statsBar: [
    { id: 'stat-exp', value: '18+', label: 'Años de experiencia en RR.HH.' },
    { id: 'stat-multi', value: '2', label: 'Multinacionales' },

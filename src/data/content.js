...
export const successCases = {
  ...
  items: [
    ...
    {
      id: 3,
      title: 'Diagnóstico y eficiencia organizacional',
      industry: 'Agroexportación',
      industryLabel: 'Agroexportadora',
      service: 'Diseño Organizacional',
      serviceId: 4,
      context: 'Revisar la estructura para optimizar costos sin afectar la operación en temporada alta.',
      solution: 'Análisis de Span of Control y propuesta de rediseño organizacional por área.',
      metrics: [
        { id: 'm3-optimizacion', value: '12%', label: 'Optimización identificada' },
